...
CFG.AVGFEAT = CN()
CFG.AVGFEAT.LOSS = CN()
CFG.AVGFEAT.LOSS.CE_WEIGHT = 1.0
CFG.AVGFEAT.LOSS.FEAT_WEIGHT = 1.0
CFG.AVGFEAT.LOSS.PREACT_WEIGHT = 0.0
CFG.AVGFEAT.LOSS.POOLED_WEIGHT = 0.0
